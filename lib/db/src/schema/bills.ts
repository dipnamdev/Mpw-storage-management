...
export const billsTable = pgTable("bills", {
  ...
  // Payment tracking fields (populated by admin after bill is approved/processed,
  // either inline or via the CSV import workflow)
  gst_tax: numeric("gst_tax", { precision: 12, scale: 2 }),
  amount_passed: numeric("amount_passed", { precision: 12, scale: 2 }),
  cheque_rtgs_no: text("cheque_rtgs_no"),
  cheque_rtgs_date: text("cheque_rtgs_date"),
  advice_no: text("advice_no"),
  advice_date: text("advice_date"),
